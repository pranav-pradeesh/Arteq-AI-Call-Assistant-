                ...
                try:
                    ...
                    async with _pp.acquire() as _pc:
                        await _pc.execute(
                            ...
                            "patient_gender=$3 WHERE call_id=$4",
                            (_pm.get("name") or None), _pm_age,
                            (_pm.get("gender") or None), call_id,
                        )
