 ...
 * datetime string (or null while nothing is selected). Responsive: the time
 * column drops below the calendar on narrow screens.
 */
...
/**
 * Deterministic faux-QR block for the receptionist payment slip. Purely
